...
public class MostAccessibleTimeStrategyData : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[]
        {
            new List<TimeRange>()
            {
                new TimeRange(new DateTime(2030, 1, 1, 8, 0, 0), new DateTime(2030, 1, 1, 10, 0, 0)),
                new TimeRange(new DateTime(2030, 1, 1, 12, 0, 0), new DateTime(2030, 1, 1, 20, 0, 0)),
                new TimeRange(new DateTime(2030, 1, 2, 8, 0, 0), new DateTime(2030, 1, 2, 18, 0, 0)),
                new TimeRange(new DateTime(2030, 1, 3, 10, 0, 0), new DateTime(2030, 1, 3, 18, 0, 0))
            },
